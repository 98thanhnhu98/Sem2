...
public class AppSecond {
        ...
        private static StudentListSecond list;
        ...
        public static void addStudent(){
            ...
            StudentSecond s = new StudentSecond(id,fn,ln,mark);
            list.add(s);
        }
        ...
        public static void searchByName(){
            ...
            name = input.next();
            LinkedList<StudentSecond> found = list.findByName(name);
            list.showList(found);
        }
        ...
        public static void searchById(){
            ...
            id = input.nextInt();
            StudentSecond s = list.findById(id);
            if (s == null){
